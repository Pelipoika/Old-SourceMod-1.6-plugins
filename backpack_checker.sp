...
{
	cvarApiKey = CreateConVar("backpack_checker_api_key", "584A7508A22A45AA36042E9A02F52ACF", "Steam Web API key, obtained from steamcommunity.com/dev");
	cvarDealMethod = CreateConVar("backpack_checker_deal_method", "4", "When a client's backpack is private: 1 = kick, 2 = warn client, 3 = warn admins, 4 = warn client and admins");
